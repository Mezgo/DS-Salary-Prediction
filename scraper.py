...
def get_jobs(keyword, num_jobs, verbose, sleep):
    ...
    while len(jobs) < num_jobs:  # If true, should be still looking for new jobs.
        ...
        for job_button in job_buttons:
            ...
            try:
                salary_estimate = driver.find_element(by=By.CLASS_NAME,
                                                      value='e1wijj242').text
                # salary_estimate = driver.find_element_by_xpath('.//span[@class="gray small salary"]').text
            except NoSuchElementException:
                salary_estimate = -1 #You need to set a "not found value. It's important."

            try:
                rating = driver.find_element(by=By.CLASS_NAME,
            ...
            try:
                driver.find_element(by=By.XPATH,
                                    value='.//div[@class="tab" and @data-tab-type="overview"]').click()
                ...
                try:
                    ...
                    #</div>
                    headquarters = driver.find_element(by=By.XPATH,
                ...
                try:
                    competitors = driver.find_element(by=By.XPATH,
